...
import { ModalCambioEstado } from '../components/organismos/ModalCambioDeEstadoUsuario'; // 👈 Asegúrate de que este nombre de archivo coincida con el tuyo
...
export const Usuarios = () => {
  ...
  const { 
    ...
    // 🚀 VARIABLES DEL NUEVO MODAL DE CAMBIO DE ESTADO
    handleToggleEstado,
    isModalEstadoOpen,
    usuarioEstado,
    accionEstado,
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-t-2xl border-t border-l border-r border-slate-200 shadow-sm overflow-hidden z-10 relative">
      ...
      {/* 🚀 EL MODAL DINÁMICO QUE CAMBIA DE COLOR (INACTIVAR/REACTIVAR) */}
      <ModalCambioEstado
